...
import { PokemonDetails } from './modelos/pokemonDetails.interfaces';
...
export class AppComponent {
    title = 'Pokemon project with powerful PrimeNG';
    ...
    buscalo(pokemon_name: string): void {
        this.selectedPokemon = [];
        this.imagen = './assets/th-140529378.jpg';
        this.capturado = true;
        ...
        details => {
            ...
            this.imagen = this.selectedPokemon[0].pic;
        },
        err => {
            console.error(err);
        }
